    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 py-16 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="relative bg-white rounded-3xl p-8 lg:p-12 border border-neutral-200 overflow-hidden">
          ...
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-blue-100 to-purple-100 opacity-30 blur-3xl rounded-full pointer-events-none" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-green-100 to-blue-100 opacity-30 blur-3xl rounded-full pointer-events-none" />
        </div>
